...
class ApiRequest
{
    private const VENDOR = 'glovo';
    private string $url;

    public function __construct()
    {
        $this->url = config('glovo.backend_api.url');
    }
     ...
     */
    public function webhook(string $action, array $data): array|null
    {
     ...
     * @return array<string, array<string>>|array<string, string>
     */
    public function confirm(string $action, array $data): array|null
    {
