...
class TokenManager
{
    ...
    {
        $this->loginUrl = config('glovo.backend_api.login_url');
        $this->refreshUrl = config('glovo.backend_api.refresh_url');
        $this->username = config('glovo.backend_api.username');
        $this->password = config('glovo.backend_api.password');
    }
